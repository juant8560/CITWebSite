...
const url = `https://gegpscswjhoezteztzqk.supabase.co/rest/v1/CaseStudyDetail?idCase=eq.${idCase}&select=idCase,idTechnologies`;
...
fetch(url, {
    ...
    .then(res => res.json())
    .then(data => {
        console.log('Verified BipBip Techs FINAL:');
